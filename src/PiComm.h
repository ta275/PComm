 ...
 * Author: tejas_advait
 *
 * Description: Mini library for parallel communication between Raspberry Pi and uC.
 * Raspberry Pi is the master and any AVR microcontroller can be a slave. This is the master code. 
 */ 
